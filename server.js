        ...
        <tr>
          <td style="padding:0 48px 32px;background:#f7fafc;">
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td style="background:linear-gradient(135deg,#667eea,#764ba2);border-radius:12px;padding:24px;text-align:center;">
                  <p style="color:#fff;font-size:17px;font-weight:700;margin:0;line-height:1.6;">&quot;Egy mentett kutya nem csak egy állatot jelent &ndash;<br>hanem egy egész életet, amit megváltoztatsz.&quot; 🐾</p>
                  <p style="color:rgba(255,255,255,0.88);font-size:13px;margin:10px 0 0;">— Robi, Ricsi &amp; Norbi csapata</p>
                </td>
              </tr>
            </table>
