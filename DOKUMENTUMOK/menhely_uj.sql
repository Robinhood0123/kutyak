...
--
-- Gép: 127.0.0.1:3307
-- Létrehozás ideje: 2026. Feb 04. 09:05
...
(19, 'Samu', 2, 'kan', NULL, 14, 'http://localhost:3000/img/kutyak/1768985879170-6951690eba32ec486a447c9a_kutya-orokbefogadas-samu-20251109-124750.jpeg', 'Samu a hevesi gyepmesteri telepről érkezett...'),
(21, 'Günther', 6, 'kan', NULL, 16, 'http://localhost:3000/img/kutyak/1768986296446-GuÌˆnter.avif', 'Készüljetek, mert itt jön GÜNTER...'),
(23, 'Róka', 7, 'kan', NULL, 15, 'http://localhost:3000/img/kutyak/1768986514275-Roka.avif', 'Nagyon okos, figyelmes kutyus...'),
(24, 'Cortez', 6, 'kan', NULL, 18, 'http://localhost:3000/img/kutyak/1768986734499-Cortez.avif', 'Cortez egy rendkívül barátságos, emberközpontú...'),
(25, 'Bendzsó', 11, 'kan', NULL, 14, 'http://localhost:3000/img/kutyak/1768986884461-Bendzso.avif', 'Bendzsó egy éber és mozgékony...'),
(26, 'Lüsy', 2, 'szuka', NULL, 15, 'http://localhost:3000/img/kutyak/1768986986913-LÃ¼sy.avif', 'Aktív, játékos, de még az új dolgoktól...'),
(27, 'Dáma', 6, 'szuka', NULL, 14, 'http://localhost:3000/img/kutyak/1768987081982-Dama.avif', 'Közepes testű, teljes oltási sorral...'),
(28, 'Anubis', 4, 'kan', NULL, 19, 'http://localhost:3000/img/kutyak/1768987201202-Anubis.avif', 'Testvérét már örökbe fogadták...'),
(29, 'Lara', 12, 'szuka', NULL, 20, 'http://localhost:3000/img/kutyak/1768987376524-Lara.avif', 'Igazi szeretetbomba, aki rajong az emberekért...'),
(31, 'Simon', 6, 'kan', NULL, 16, 'http://localhost:3000/img/kutyak/1768987581431-Simon.avif', 'Okos, étellel jól motiválható...'),
(32, 'Ava', 7, 'szuka', NULL, 15, 'http://localhost:3000/img/kutyak/1768987745953-Ava.avif', 'Ava útja nehezen indult: mély szorongással...'),
(33, 'Joya', 1, 'szuka', NULL, 14, 'http://localhost:3000/img/kutyak/1768987844185-jOYA.avif', 'Ez a figyelemreméltó, értelmes tekintetű...'),
(34, 'Shiva', 6, 'szuka', NULL, 16, 'http://localhost:3000/img/kutyak/1768987996823-Shiva.avif', 'Atletikus alkatú egy igazi energiabomba...'),
(35, 'Nala', 8, 'szuka', NULL, 16, 'http://localhost:3000/img/kutyak/1768988110550-Nala.avif', 'Ez a rendkívül stabil, izmos felépítésű...'),
(36, 'Babóca', 1, 'szuka', NULL, 16, 'http://localhost:3000/img/kutyak/1768988350489-Baboca.avif', 'Idővel elkezdett bízni a gondozóiban...'),
(37, 'Némo', 3, 'kan', NULL, 14, 'http://localhost:3000/img/kutyak/1768988474567-Nemo.avif', 'Akiket megismer, azokhoz bújik...'),
(38, 'Franciska', 4, 'szuka', NULL, 22, 'http://localhost:3000/img/kutyak/1768988604407-Franciska.avif', 'Ez a rendkívül elegáns megjelenésű...'),
(39, 'Keksz', 2, 'kan', NULL, 16, 'http://localhost:3000/img/kutyak/1768988769076-Keksz.avif', 'Keksz egy rendkívül stabil...'),
(40, 'Mazsola', 8, 'kan', NULL, 14, 'http://localhost:3000/img/kutyak/1768988914395-Mazsola.jpeg', 'Mazsola egy igazán különleges kis egyéniség...'),
(41, 'Stella', 2, 'szuka', NULL, 14, 'http://localhost:3000/img/kutyak/1768989008696-679e9a75b5807f3414a2a19c_Stella3-p-1080.jpg', 'Ivartalanított, kis-közepes termetű...'),
(42, 'Károly', 6, 'kan', NULL, 15, 'http://localhost:3000/img/kutyak/1768989768700-Karcsin.jpg', 'Napokban került a telepre egy szomorú szemű...');
